  ...
  const navigationItems = useMemo<MenuItem[]>(() => ([
    ...
    },
    {
      ...
      children: [
        ...
        // },
        {
          key: 'publisher.materials.submitted-materials.index',
          label: 'Submitted',
          icon: <SendHorizontal size={15} />,
          onClick: () => router.visit('/publisher/materials/submitted-materials'),
        },
        {
          key: 'publisher.materials.publish-materials.index',
          label: 'Published',
          icon: <BookCheck size={15} />,
          onClick: () => router.visit('/publisher/materials/published-materials'),
        },
        {
          key: 'publisher.materials.new-material.index',
          label: 'New Post/Material',
          icon: <Plus size={15}/>,
          onClick: () => router.visit('/publisher/materials/new-material/create'),
        },
        // {
