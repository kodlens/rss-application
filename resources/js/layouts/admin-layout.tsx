...
import { Book, DatabaseZap,
    LandPlot,
    LogOut,
    Newspaper, Sparkle,
    SquareArrowOutUpRight,
    SquareChartGantt, UserPen,
...
export default function AdminLayout(
  ...
  const pageTitle = currentMenuKey === 'admin.dashboard'
    ? 'Dashboards'
    : currentMenuKey === 'admin.categories.index'
      ? 'Categories'
  ...
  const navigationItems = useMemo<MenuItem[]>(() => ([
    ...
    },
    {
      key: 'admin.topics',
      icon: <Book size={15}/>,
      label: 'Topics', //this is subjects, but display as categories
      ...
      children: [
        {
          ...
          label: 'All Materials',
          icon: <FormOutlined />,
          onClick: () => router.visit('/admin/all-materials'),
        },
        {
