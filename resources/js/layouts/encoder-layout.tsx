  ...
  const navigationItems = useMemo<MenuItem[]>(() => ([
    ...
    },
    {
        ...
        children: [
          ...
          {
            key: 'encoder.drafted-materials.index',
            icon: <SquarePen size={15}/>,
            label: 'Drafted',
            onClick: () => router.visit('/encoder/drafted-materials'),
          },
          {
            key: 'encoder.submitted-materials.index',
            icon: <SendHorizontal size={15}/>,
            label: 'Submitted',
            onClick: () => router.visit('/encoder/submitted-materials'),
          },
          {
            key: 'encoder.published-materials.index',
            icon: <BookCheck size={15}/>,
            label: 'Published',
            onClick: () => router.visit('/encoder/published-materials'),
          },
          {
