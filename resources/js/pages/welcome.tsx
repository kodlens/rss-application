          ...
          <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              <div className='w-80 mt-4'>
                <img src="/img/app-logo-black-update.png" alt="DOST-STII mark" className="" />
              </div>
                    ...
                    jobPositions.map((job) => (
                      <tr key={job.job_position_id} className="hover:bg-slate-50">
                        <td className="px-5 py-4 align-top">
                          <p className="text-slate-600 font-mono">{job.job_position_code}</p>
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 py-10 md:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
            <div>
              <div className="flex items-center gap-3">
                <div className="w-80 shrink-0 items-center justify-center rounded-md">
                  <img src="/img/app-logo-white.png" alt="DOST-STII mark" />
                </div>
                {/* <div>
